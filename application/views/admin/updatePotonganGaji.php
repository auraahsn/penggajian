    ...
    <div class="card" style="width: 65%;">
        <div class="card-body">
            ...
            <?php foreach ($pot_gaji as $p) :  ?>
                <form method="POST" action="<?php echo base_url('AdminController/PotGaji/updateDataAction') ?>">
                    <div class="form-group">
                        <label>Jenis Potongan</label>
                        <input type="hidden" name="id_pot_gaji" class="form-control" value="<?php echo $p->id_pot_gaji ?>">
